...
public class S3SinkTask extends SinkTask {
    ...
    public void start(Map<String, String> props) {
        ...
        try {
            avroSchema = new Schema.Parser().parse(new File("C:/Users/ADMIN/Downloads/Projects/avro-latest/avro-s3-new/src/main/resources/LoanRepaymentScheduleCreated.avsc"));
        } catch (IOException e) {
